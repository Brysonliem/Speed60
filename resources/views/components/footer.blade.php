    ...
    <div class="w-full flex flex-col md:flex-row min-h-full" id="our-store">
        ...
        <div class="w-full md:w-1/2 bg-gray-500 text-white flex items-center justify-center p-8">
            <div class="text-center space-y-6">
                ...
                <button
                    class="text-white bg-blue-600 hover:bg-blue-700 font-bold rounded-lg text-sm px-6 py-3 transition duration-300">
                    Our Location
                </button>
                </a>
            </div>
...
<div class="bg-black text-white text-center py-3 text-sm">
    © 2025 Speed60. All rights reserved.
</div>

    ...
    <div class="flex flex-col gap-4 p-4 md:p-8">
        <div class="">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-4 md:p-6 z-10">
                ...
                <a href="{{ route('products.index') }}" class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 md:py-3 md:px-6 rounded-full transition duration-300 text-sm md:text-base">
                Get Your Bolts Now →
                </a>
            </div>
        </div>

...
<div class="mt-14">
    <div class="bg-white border p-3 max-w-screen hover:shadow">
                ...
                <div>
                    ...
                    <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 border p-1">
                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownActionButton">
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-red-600 hover:text-white rounded-md">Reward</a>
                            </li>
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-red-600 hover:text-white rounded-md">Promote</a>
                            </li>
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-red-600 hover:text-white rounded-md">Activate account</a>
                            </li>
                        </ul>
                        {{-- <div class="py-1">
